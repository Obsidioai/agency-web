        ...
        <div className="mx-auto max-w-4xl space-y-10">
          ...
          <Section title="Your Rights">
            ...
            <ul className="list-disc space-y-3 pl-5">
              ...
              <li>
                <strong>Right to Lodge a Complaint:</strong> If you believe your data protection rights have been violated or you have serious concerns about how we handle your data, you have the right to lodge a complaint with a supervisory data protection authority. You may do so in the EU Member State where you reside, work, or where the issue occurred. As Obsidio is based in Austria, you can also contact the Austrian Data Protection Authority (Oesterreichische Datenschutzbehorde). We would, however, appreciate the chance to address your concerns first - so please feel free to contact us directly, and we will do our best to resolve any issues.
              </li>
            </ul>
            <p>
